// Step 19 — Win / Loss leaves the nav for a row of tiles on the Client Dashboard, the client list
...
//
//   NODE_PATH=/path/to/node_modules node tests/browser/step19.js [/abs/path/to/havellin.html]
...
(async () => {
  ...
  console.log('\nstep19: ' + pass + ' passed, ' + fail + ' failed, ' + errs.length + ' page errors');
  await b.close();
