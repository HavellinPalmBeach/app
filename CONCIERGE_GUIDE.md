...
### What the client has to do — three things, and one of them is new

Worth knowing before they phone you about it. On the signing screen they are asked for their **signature**, the **date**, and a **marketing choice**. That is all. **No initials anywhere, and no role tick box** — both were removed on 2026-09-18.

> **⚠** **The marketing choice is required; the marketing signature is not.** They must pick *I AUTHORIZE* or *I DO NOT AUTHORIZE* — DocuSign will not let them finish without answering. Only if they authorize does a second signature line appear; if they decline, they never see it. **Declining costs them one click and changes nothing** about the work, the fee, or any other term, and it is worth saying so if they hesitate. **⚠ The default is NO.** It used to be the other way round — the old agreement allowed marketing use unless the client ticked a box to stop it. Now nothing gets published unless they say yes and sign for it. **If a client asks whether we will post about their house: only if they authorize it, and even then no address, no names, and no faces.**
...
| **A client asks what the two tick boxes about marketing are** | They are choosing whether Havellin may use photos or video from their job for marketing. **They must pick one** — DocuSign will not let them finish otherwise — but **declining costs them nothing** and changes no term of the agreement. If they authorize, a signature line appears under the boxes; if they decline, it never does. Say plainly: no address, no names, no faces, ever, and they can withdraw it later in writing. |
| **A client says there is a signature line they cannot sign** | That is the marketing signature and it is **only** live if they picked *I AUTHORIZE*. DocuSign hides it entirely on the other answer. If it is showing and they do not want it, they picked authorize by mistake — they can change the answer and it disappears. |
| **An older agreement had an initials box for photography and this one does not** | Removed 2026-09-18, deliberately. We do not ask permission to photograph a house we have been hired to inventory — the agreement states what we do with the media instead. **Marketing use is the separate question**, and that is the one they answer. |
