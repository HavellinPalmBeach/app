...
Worth knowing before they phone you about it. On the signing screen they are asked for their **signature** and the **date**. That is all that is required. On a **living-client** agreement there is also one optional tick box about marketing, at the end of §10.2. **No initials anywhere, and no role tick box** — both were removed on 2026-09-18.

> **⚠** **The marketing box is an OPT-OUT. Leaving it alone is a yes.** One box, reading *I DO NOT AUTHORIZE any marketing or promotional use*. They tick it to decline; they leave it blank to authorize. **Ticking it changes nothing** about the work, the fee, or any other term — say so if they hesitate. **⚠ They can also decline in writing at any time, ticked box or not**, and withdraw an authorization later the same way. That is in §10.2 and it is the answer to give if a client rings after signing and says they have changed their mind. Withdrawing is forward-looking — it does not require pulling down anything already posted. **⚠ If a client asks whether we will post about their house:** yes, unless they tick the box or tell us in writing — and **never their address, never their name, never a face**, on any answer. **⚠⚠ ON AN ESTATE OR PROBATE JOB THERE IS NO BOX AND NO CHOICE.** That agreement says outright that we do not use estate media for marketing, full stop. If a representative asks, the answer is not *"only if you agree"* — it is **"we don't, and the agreement says so."** Do not offer it as a favour, and do not arrange it on the side; the agreement says no such right exists under it.
...
> **Photographing the house is not one of the choices, and we do not ask permission for it.** That is how the inventory, the appraisal support and the chain of custody get built — it is the work they are paying for. The agreement says where the media is kept, who can see it, and that it is never sold or shared. If they ask, that is the answer; the marketing consent is a separate question and they answer that one themselves.
...
| **A representative on an estate job asks about the marketing box, or offers to let us post** | There is no box on that form, and the answer is not *"only if you agree"*. **We do not use estate media for marketing at all**, §7.2 says so, and it says no such right is available under the agreement by consent either. Do not arrange it on the side. |
