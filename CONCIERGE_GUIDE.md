...
- **The final states how far off the estimate it landed, and it never says you called the client.** A job over the estimate prints *"Job ran over estimate by $1,360 (5.3%) — inside the 15% tolerance in your agreement"*, or *beyond* it past 15%. **Corrected 2026-09-11:** it used to read *"client was notified per T&Cs"* on *any* overage however small — a claim the app has no record of at any size, on a job where no notice was owed. Nothing about the money changed.
...
| The final invoice says the client was notified that the job ran over, and nobody called them | Fixed 2026-09-11. That sentence printed on *every* overage, however small, and the app has never recorded a notification at any size. It now states the overage as a percentage and says whether it is inside or beyond the 15% in the agreement, and claims nothing about a conversation. **Notice is owed only past 15%** — and past 15% what you want is a change order agreed before the hours are worked, not a line on the bill afterwards. Re-print any final issued before today. |
