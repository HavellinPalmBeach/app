...
| The *Email to Client* button opens a Gmail page saying *"Your account is not available"* | Fixed 2026-09-09 — the link was built wrongly. **The draft was still created.** Use the *Open the draft in Gmail* link that now prints under the buttons, or just look in your Gmail Drafts. |
