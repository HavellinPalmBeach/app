...
- **Property Specialists** — crew is auto-sized to the smallest number that lands the job inside the 10-working-day target (floor 2, cap 6). You can add specialists manually up to the cap.
...
- **Preferred Client Discount** — percentage off Havellin labor fees only (max 30%)
